...
function convertToHours() {
    ...
    document.getElementById("result").textContent = `${minutes} minutos son ${hours} horas.`;
}
...
function convertToFahrenheit() {
    ...
    document.getElementById("result").textContent = `${celsius} grados Celsius son ${fahrenheit} grados Fahrenheit.`;
}
...
function calculateCapital() {
    ...
    document.getElementById("result").textContent = `El capital es de ${capital}.`;
}
...
function calculateFrequency() {
    ...
    document.getElementById("result").textContent = `La frecuencia es de ${frequency}.`;
}
...
function calculatePower() {
    ...
    document.getElementById("result").textContent = `La potencia es de ${power} watts.`;
}
...
function calculateTotal() {
    ...
    document.getElementById("result").textContent = `El total a pagar es de $${total}.`;
}
...
function calculateAnualidad() {
    ...
    document.getElementById("result").textContent = `Las anualidades a pagar son de $${anualidad.toFixed(2)} por año.`;
  }
...
function calculateSalary() {
    ...
    document.getElementById("result").textContent = `El salario es de $${salario} por ${horas} horas trabajadas.`;
}
...
function convertToSeconds() {
  ...
  document.getElementById("result").textContent = `${horas} horas son ${segundos} segundos.`;
}
...
function calculateForce() {
    ...
    document.getElementById("result").textContent = `La fuerza es de ${fuerza} Newtons.`;
  }